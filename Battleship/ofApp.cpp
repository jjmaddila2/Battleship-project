...
void ofApp::setup() {
	//using sound for backround for winning, losing and backround music
	winner.load("you_win.wav");
	loser.load("you_lose.wav");
	backround.load("In.mp3");
	backround.setVolume(.3);
	backround.play();
	backround.setLoop(true);
